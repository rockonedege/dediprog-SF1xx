...
CAT45DBxxxB::CAT45DBxxxB(CUSB& usb, const memory::memory_id& id)
            :CSerialFlash(usb, id)           
{
...
size_t CAT45DBxxxB::GetChipSizeInBytes() const
{
    return m_chipSize;
}
size_t CAT45DBxxxB::GetPageSizeInBytes() const
{
    return m_pageSize;
}

void CAT45DBxxxB::waitForWEL()  // override
{
...
unsigned char CAT45DBxxxB::getWriteMode()
{
	return 2;
    //unsigned char cMode;
    //unsigned char cSR ;
...
void CAT45DBxxxB::waitForWIP()  // override
{    
    unsigned char cSR ;
    size_t i = MAX_TRIALS;
    // wait until WIP = 0
...
tribool CAT45DBxxxB::protectBlock(tribool bProtect)
{
    // SR :
    //  7   6 5  4   3   2   1   0
...
bool CAT45DBxxxB::EnableEraseSectorProtectionRegister()
{
...
bool CAT45DBxxxB::EraseSectorProtectionRegister()
{
    vector<unsigned char> v;
...
bool CAT45DBxxxB::ProgramSectorProtectionRegister(const vector<unsigned char>& vc)
{
    vector<unsigned char> v;
...
vector<unsigned char> CAT45DBxxxB::ReadSectorProtectionRegister()
{
...
bool CAT45DBxxxB::ValidateAddr(size_t addr)
{
    return (m_pageSizeMask  &  addr) <=  (m_pageSizeMask &  m_pageSize);
}


tribool CAT45DBxxxB::bulkPipeProgram(const pair<size_t, size_t>& AddrRange, vector<unsigned char>& vData, unsigned char modeWrite)
{
    /*  modeWrite:
        1: page-size = 256
        2: page-size = 264
...
void CAT45DBxxxB::PrependPageModeInfo()
{
